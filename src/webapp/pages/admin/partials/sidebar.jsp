  ...
  <ul class="list-unstyled components text-secondary">
    ...
    <li>
      ...
      <ul class="collapse list-unstyled" id="authmenu">
        <li>
          <a href="<%=context%>/admin/users/?type=<%=RoleConstants.ADMIN%>"
            ><i class="fas fa-user-cog"></i>Admin</a
          >
        </li>
        <li>
          <a href="<%=context%>/admin/users/?type=<%=RoleConstants.TEACHER%>"
            ><i class="fas fa-chalkboard-teacher"></i> Teachers</a
          >
        </li>
        <li>
          <a href="<%=context%>/admin/users/?type=<%=RoleConstants.STUDENT%>"
    ...
    <li>
      <a href="<%=context%>/admin/groups"><i class="fas fa-users"></i>Groups</a>
    </li>
...
=======
    <li>
      <a href="<%=context%>/admin/topics"
        ><i class="fas fa-newspaper"></i>Topics</a
      >
    </li>
    <li>
      <a
        href="#registration-priods"
        data-bs-toggle="collapse"
        aria-expanded="false"
        class="dropdown-toggle no-caret-down"
        ><i class="fas fa-clock"></i>Registration Periods</a
      >
      <ul class="collapse list-unstyled" id="registration-priods">
        <li>
          <a href="<%=context%>/admin/registration-priods"
            ><i class="fas fa-user-cog"></i>For Teacher</a
          >
        </li>
        <li>
          <a href="<%=context%>/admin/users"
            ><i class="fas fa-chalkboard-teacher"></i>For Student</a
          >
        </li>
      </ul>
    </li>
    <li>
      <a href="<%=context%>/admin/boards"
        ><i class="fas fa-chalkboard-teacher"></i> Boards</a
      >
    </li>
  </ul>
</nav>
>>>>>>> 2c43e7de8e3188a24a2a0db5f0addcb029587213
