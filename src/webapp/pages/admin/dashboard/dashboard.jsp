...
<body>
	...
	<script type="text/javascript"
		src="<%=context%>/assets/js/chart/Chart.min.js"></script>
	<script type="text/javascript"
		src="<%=context%>/assets/js/chart/chart-area-demo.js"></script>
	<script type="text/javascript"
		src="<%=context%>/assets/js/chart/chart-pie-demo.js"></script>
</body>
</html>